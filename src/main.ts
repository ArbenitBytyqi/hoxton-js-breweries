...
function createSingleBreweryLi(brewery: Brewery) {
  ...
  breweryLi.append(breweryTitle, breweryTypeDiv, breweryAddressSection, breweryPhoneSection, breweryLinkSection)
  breweryAddressSection.append(breweryAddressTitle, breweryAddressLine1, breweryAddressLine2)
